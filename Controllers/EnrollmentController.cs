...
namespace ContosoUniversity2020.Controllers
{
    ...
    public class EnrollmentController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StudentID"] = new SelectList(_context.Students, "ID", "FullNameAlt");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,CourseID,StudentID,Grade")] Enrollment enrollment)
        {
            ...
            ViewData["StudentID"] = new SelectList(_context.Students, "ID", "FullNameAlt", enrollment.StudentID);
            return View(enrollment);
        }
